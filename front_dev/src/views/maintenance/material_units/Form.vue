  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <div class="text-right">
        <router-link to="/maintenance/material-units/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/material_units/get',{params:{id:this.$route.params.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/material_units/save',this.form).then(response => {
