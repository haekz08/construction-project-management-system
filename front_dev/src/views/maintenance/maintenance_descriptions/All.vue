...
<script>
    ...
    export default {
      ...
      data: () => {
          return {
              table_settings:{
                  api_url:'maintenance/maintenance_descriptions/all',
                  delete_url:'maintenance/maintenance_descriptions/delete',
                  fields:[
      ...
      created(){
        bus.$on('serverSidePaginatedTableDbClick', (data)=>{
            this.$router.push('/maintenance/maintenance-descriptions/update/'+data.id);
        });
      }
    }
</script>
