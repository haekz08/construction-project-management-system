  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <div class="text-right">
        <router-link to="/maintenance/maintenance-descriptions/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/maintenance_descriptions/get',{params:{id:this.$route.params.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/maintenance_descriptions/save',this.form).then(response => {
