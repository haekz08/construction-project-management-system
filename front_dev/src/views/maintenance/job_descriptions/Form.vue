<template>
  <div>
    ...
    <b-form @submit="save">
      ...
      >
        <b-form-input
          v-model="form.daily_rate.default"
          type="number"
          step="any"
          required
        ></b-form-input>
      ...
      <div class="text-right">
        <router-link to="/maintenance/job-descriptions/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/job_descriptions/get',{params:{id:this.$route.params.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                ...
                form.daily_rate=form.daily_rate.default;
                this.axios.post('maintenance/job_descriptions/save',form).then(response => {
