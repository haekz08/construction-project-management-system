  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <div class="text-right">
        <router-link to="/maintenance/other-expenses/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/other_expenses/get',{params:{id:this.$route.params.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/other_expenses/save',this.form).then(response => {
