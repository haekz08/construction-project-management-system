  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <b-form-group
        ...
        description="This field is required"
      >
        <select class="form-control" v-model="form.material_unit_id" required>
            <option value="">Please Select</option>
            <option v-for="material_unit in material_units" :value="material_unit.id">
                {{material_unit.description}}
            </option>
        </select>
      </b-form-group>

      <div class="text-right">
        <router-link to="/maintenance/materials/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/materials/get',{params:{id:this.$route.params.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/materials/save',this.form).then(response => {
        ...
        getFields(){
          this.is_saving=true;
          this.axios.get('maintenance/material_units/all').then(response => {
