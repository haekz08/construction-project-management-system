  ...
  <div>
    <div class="card bg-light mb-0">
      <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
          <h6 class="mb-0"><font-awesome-icon icon="plus-circle" /> Material Inventory Issuance</h6>
      </div>
      <div class="card-body bg-white position-relative">
          ...
          <b-row class="m-0 mb-3">
            ...
            <b-col class="p-0 pl-1">
              <b-row class="m-0">
                  ...
                  <b-col class="p-2 bg-light">
                    <small class="text-muted">Total Issuance Amount</small>
                      <input  type="text" 
          ...
          <div class="card bg-light mb-0 mt-3">
            <div class="card-header bg-secondary d-flex justify-content-between align-items-center">
                ...
                <b-button variant="dark" size="sm" @click="material_modal=true" v-if="editable && form.warehouse_id!=-1">
              ...
              <table class="table border mb-0">
                <thead class="bg-light text-dark">
                  <tr>
                    ...
                    <th scope="col" class="text-center">Current Stocks</th>
                    <th scope="col" class="text-center">Issuance Qty</th>
                      <th scope="col" class="text-center">Total</th>
                    <th scope="col" class="text-center" v-if="editable">Action </th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(material_delivery_detail, index) in form.material_issuance_details">
                    ...
                    <td class="text-right">
                        <number-format-component :currency="false" :input_value="Number(material_delivery_detail.balance)"/>
                    </td>
                    ...
                    <td>
                      <b-form-input
                        ...
                        type="number"
                        step="any"
                        :max="material_delivery_detail.balance"
                        required
                        class="text-right"
                      ></b-form-input>
                    </td>
                ...
                <tfoot class="bg-light text-dark">
                  <tr>
                    <th scope="col" class="text-right" colspan="4">TOTAL ISSUANCE AMOUNT</th>
    ...
    export default {
      ...
      watch: {
        material_issuance:{
            immediate: true,
            handler(){
              if(typeof this.material_issuance.id != 'undefined')
                this.form = this.material_issuance;
            }
        },
        form:{
            immediate: true,
            ...
            handler(){
              ...
              this.form.material_issuance_details.forEach((value, index) => {
      ...
      computed: {
          total(){
              return this.form.material_issuance_details.reduce((total, value)=>{
      ...
      methods: {
        save(){
          if(this.form.warehouse_id==-1){
            this.swal_transaction_error_data.text = "Please select a warehouse";
            this.swalRequestError();
            return
          }
          if(this.form.material_issuance_details.length<=0){
            this.swal_transaction_error_data.text = "Please select a material/s.";
            this.swalRequestError();
            return
          }

            if(this.form.project_item_id==-1){
                this.swal_transaction_error_data.text = "Please select a reference Project";
                this.swalRequestError();
                return
            }
          this.swalConfirmSubmit((data)=>{
            ...
            if (data.value) {
              ...
              this.axios.post('inventory/issuances/save',this.form).then(response => {
        ...
        selectMaterial(material){
          if(this.form.material_issuance_details.find(x => (x.material_id === material.id && Number(x.price) === Number(material.price))))
          {
          ...
          this.form.material_issuance_details.push(data);
          this.material_modal=false;
        },
        deleteMaterial(index){
          this.swalConfirmDelete((data)=>{
              if (data.value) {
                this.form.material_issuance_details.splice(index, 1);
              }
          });
        }
      }
