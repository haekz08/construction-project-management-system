        ...
        <div class="card bg-light mb-3">
            ...
            <div class="card-body bg-white mb-0">
                ...
                >
                    ...
                    <template v-slot:cell(starting_inventory)="data">
                        <div class="h5 mb-0">{{data.item.starting_inventory.project_location_structure_item.project_location_structure.project_location.project.title}}</div>
                        <div class="small text-muted">
                            {{data.item.starting_inventory.project_location_structure_item.project_location_structure.project_location.description}}
                            | {{data.item.starting_inventory.project_location_structure_item.project_location_structure.description}}
                            | {{data.item.starting_inventory.project_location_structure_item.description}}
                        </div>
                    </template>
                </b-table>
