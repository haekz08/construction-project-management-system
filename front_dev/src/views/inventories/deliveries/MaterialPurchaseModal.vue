  ...
  <div>
    <div class="card bg-light mb-0">
      <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
          <h6 class="mb-0"><font-awesome-icon icon="search" /> Material Purchase Search</h6>
      </div>
        ...
        <div class="position-relative">
          ...
          <div class="card bg-light mb-0 mt-2"  v-for="result in results">
            <div class="card-header bg-secondary text-dark d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><font-awesome-icon icon="map-marker" /> {{result.project_location_structure_item.project_location_structure.project_location.project.title}}</h6>
            </div>
                ...
                <b-col class="p-2 bg-white d-flex align-items-center border">
                    ...
                    <h2 class="mb-0">
                      <a href="#" @click.prevent="viewDetails(result)">
                        <strong @click="viewDetails(result)">{{result.order_number}}</strong>
                      </a>
                    </h2>
                    </div>
                </b-col>
              ...
              <div class="card-group mb-0">
                <div class="card">
                  <div class="card-block p-3">
                    ...
                    <div class="h5 mb-0">{{result.project_location_structure_item.project_location_structure.project_location.description}}</div>
                ...
                <div class="card">
                  <div class="card-block p-3">
                    ...
                    <div class="h5 mb-0">{{result.project_location_structure_item.project_location_structure.description}}</div>
                ...
                <div class="card">
                  <div class="card-block p-3">
                    ...
                    <div class="h5 mb-0">{{result.project_location_structure_item.description}}</div>
    ...
    <b-modal v-model="details_modal" centered size="xl" body-class="p-0" :hide-footer="true" :hide-header="true">
      <modal :material_purchase="material_purchase"/>
    </b-modal>
  </div>
</template>
<script>
    ...
    import Modal from '@/views/inventories/purchases/Modal.vue';
    export default {
      mixins:[SwalMixin],
      ...
      methods: {
        getProjects(){
            this.is_saving=true;
            this.axios.get('inventory/purchases/search?search=' + this.search_key).then(response => {
