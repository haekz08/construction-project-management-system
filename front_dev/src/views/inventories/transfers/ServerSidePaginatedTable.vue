        ...
        <div class="card bg-light mb-3">
            <div class="card-header bg-dark text-white">
                <b-row>
                    ...
                    <b-col class="text-right">
                        <router-link to="add" v-if="top_right_btn_redirect">
                            <b-button variant="secondary" size="sm">
                                <font-awesome-icon icon="plus" /> Add New Record
                            </b-button>
                        </router-link>

                        <b-button variant="secondary" size="sm" v-else @click="clickTopRightBtn">
                            <font-awesome-icon icon="plus" /> Add New Record
                        </b-button>
                    </b-col>
                </b-row>
            ...
            <div class="card-body bg-white mb-0">
                ...
                >
                    ...
                    <template v-slot:cell(project_location_structure_item_from)="data">
                        <div class="h5 mb-0">{{data.item.project_location_structure_item_from.project_location_structure.project_location.project.title}}</div>
                        <div class="small text-muted">
                            {{data.item.project_location_structure_item_from.project_location_structure.project_location.description}}
                            | {{data.item.project_location_structure_item_from.project_location_structure.description}}
                            | {{data.item.project_location_structure_item_from.description}}
                        </div>
                    </template>
                    <template v-slot:cell(project_location_structure_item_to)="data">
                        <div class="h5 mb-0">{{data.item.project_location_structure_item_to.project_location_structure.project_location.project.title}}</div>
                        <div class="small text-muted">
                            {{data.item.project_location_structure_item_to.project_location_structure.project_location.description}}
                            | {{data.item.project_location_structure_item_to.project_location_structure.description}}
                            | {{data.item.project_location_structure_item_to.description}}
                        </div>
                    </template>
                </b-table>
