  ...
  <div>
    <div class="card bg-light mb-0">
      <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
          <h6 class="mb-0"><font-awesome-icon icon="plus-circle" /> Material Inventory Withdrawal</h6>
      </div>
          ...
          <b-row class="m-0 mb-3">
            ...
            <b-col class="p-0 pl-1">
              <b-row class="m-0">
                  ...
                  <b-col class="p-2 bg-light">
                    <small class="text-muted">Total Withdrawn Amount</small>
                      <input  type="text" 
              ...
              <table class="table border mb-0">
                <thead class="bg-light text-dark">
                  <tr>
                    ...
                    <th scope="col" class="text-center">Withdrawn Qty</th>
                      <th scope="col" class="text-center">Total</th>
                    <th scope="col" class="text-center" v-if="editable">Action </th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(material_delivery_detail, index) in form.material_withdrawal_details">
                ...
                <tfoot class="bg-light text-dark">
                  <tr>
                    <th scope="col" class="text-right" colspan="4">TOTAL WITHDRAWN AMOUNT</th>
    ...
    export default {
      ...
      watch: {
        material_withdrawal:{
            immediate: true,
            handler(){
              if(typeof this.material_withdrawal.id != 'undefined')
                this.form = this.material_withdrawal;
            }
        },
        form:{
            immediate: true,
            ...
            handler(){
              ...
              this.form.material_withdrawal_details.forEach((value, index) => {
      ...
      computed: {
          total(){
              return this.form.material_withdrawal_details.reduce((total, value)=>{
      ...
      methods: {
        save(){
          ...
          if(this.form.material_withdrawal_details.length<=0){
          ...
          this.swalConfirmSubmit((data)=>{
            ...
            if (data.value) {
              ...
              this.axios.post('inventory/withdrawals/save',this.form).then(response => {
        ...
        selectMaterial(material){
          if(this.form.material_withdrawal_details.find(x => (x.material_id === material.id && Number(x.price) === Number(material.price))))
          {
          ...
          this.form.material_withdrawal_details.push(data);
          this.material_modal=false;
        },
        deleteMaterial(index){
          this.swalConfirmDelete((data)=>{
              if (data.value) {
                this.form.material_withdrawal_details.splice(index, 1);
              }
          });
        }
      }
