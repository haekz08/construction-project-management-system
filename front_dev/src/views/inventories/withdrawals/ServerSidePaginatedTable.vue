            ...
            <div class="card-body bg-white mb-0">
                ...
                >
                    ...
                    <template v-slot:cell(total)="data">
                        <h6 class="text-right"><number-format-component :input_value="Number(data.item.total)"/></h6>
                    </template>
                    <template v-slot:cell(project)="data">
                        <div class="h5 mb-0">{{data.item.project_location_structure_item.project_location_structure.project_location.project.title}}</div>
                        <div class="small text-muted">
                            {{data.item.project_location_structure_item.project_location_structure.project_location.description}}
                            | {{data.item.project_location_structure_item.project_location_structure.description}}
                            | {{data.item.project_location_structure_item.description}}
                        </div>
                    </template>
                </b-table>
