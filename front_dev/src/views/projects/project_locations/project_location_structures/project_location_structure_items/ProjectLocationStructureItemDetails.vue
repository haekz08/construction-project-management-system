<template>
  ...
  <b-modal v-model="add_project_location_structure_item_modal" centered size="md" body-class="p-0" :hide-footer="true" :hide-header="true">
    <!-- <project-location-form-component @addProjectLocationStructure="addProjectLocationStructure" /> -->
  </b-modal>
...
<script>
    ...
    export default {
      components: {ProjectLocationStructureFormComponent},
      data() {
        return {
      ...
      methods: {
          ...
          get(){
            this.is_saving=true;
            this.axios.get('project/project_location/project_location_structures/get',{params:{id:this.$route.params.project_location_structure_id}}).then(response => {
