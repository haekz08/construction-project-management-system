<template>
  <div class="p-2">
    ...
    <h3 class="text-center">WORK ACCOMPLISHMENT REPORT (per item)</h3>
...
<script>
    ...
    export default {
      ...
      computed: {
        ...
        grand_amount(){
          return this.result.reduce((total, value)=>{
            return total + Number(value.grand_total_est.default);
          },0);
        },
        grand_weight(){
          return this.result.reduce((total, value)=>{
      ...
      methods: {
        generate(){
          ...
          this.axios.get('reports/work-accomplishment-per-item',{params:this.form}).then(response => {
