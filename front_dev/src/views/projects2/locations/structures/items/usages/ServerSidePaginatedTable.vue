...
<script>
    ...
    export default {
        ...
        methods: {
            getAll() {
                this.loading = true;
                this.axios.get(this.api_url + '?id='+this.project_location_structure_item_id+'&page=' + this.list.current_page + '&per_page=' + this.selected_display_no + '&search=' + this.search_term).then(response => {
