            ...
            <div class="card-body bg-white">
                ...
                >
                    ...
                    <template v-slot:cell(date)="data">
                        {{data.item.transaction_date.other_formats.format_1}} | {{data.item.transaction_time.other_formats.format_1}}
                    </template>
...
<script>
    ...
    export default {
        ...
        created(){
            bus.$on('reloadIndirectExpenseTable', ()=>{
                this.getAll();
            });
        },
        methods: {
            getAll() {
                this.loading = true;
                this.axios.get(this.api_url + '?project_id='+this.project_id+'&page=' + this.list.current_page + '&per_page=' + this.selected_display_no + '&search=' + this.search_term).then(response => {
