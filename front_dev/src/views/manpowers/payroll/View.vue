          ...
          <table class="table table-bordered mb-0 mt-3">
            ...
            <tbody>
              <tr v-for="(payroll_detail, index) in payroll.payroll_details">
                ...
                <td class="text-right">
                  <number-format-component :input_value="Number(payroll_detail.sss_payment)" :currency="false" />
                </td>
                <td class="text-right">
                  <number-format-component :input_value="Number(payroll_detail.philhealth_payment)" :currency="false" />
                </td>
                <td class="text-right">
                  <number-format-component :input_value="Number(payroll_detail.pagibig_payment)" :currency="false" />
                </td>
                <td class="text-right">
