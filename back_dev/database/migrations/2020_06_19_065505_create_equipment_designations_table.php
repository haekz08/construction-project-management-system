...
class CreateEquipmentDesignationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('equipment_designations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('equipment_designations');
    }
}
